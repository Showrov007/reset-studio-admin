...
// Types
export type AvatarStyle = "Female 1" | "Male 1" | "Female 2" | "Male 2";
...
const FemaleAvatar1: React.FC = () => (
  <svg
    viewBox="0 0 300 260"
    className="w-full h-[220px] bg-[#f4f4f4] rounded-t-lg"
  >
...
const MaleAvatar1: React.FC = () => (
  <svg viewBox="0 0 300 260" className="w-full h-[220px] bg-white rounded-t-lg">
    ...
    />
    <path
      d="M 175 130 Q 205 160 225 170 Q 210 180 185 170"
      fill="none"
      stroke="#f5c09e"
      strokeWidth="12"
      strokeLinecap="round"
...
export const InstructorsPage: React.FC = () => {
  ...
  const [avatarStyle, setAvatarStyle] = useState<AvatarStyle>("Female 1");
  ...
  const renderAvatar = (style: AvatarStyle) => {
    switch (style) {
      case "Female 1":
  ...
  return (
    <div className="max-w-[1150px] mx-auto font-sans">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-[28px] font-bold mb-1 text-[#1a1a1a] font-serif leading-tight">
          Instructors
        </h1>
        <p className="text-[#8a8479] text-[13px] m-0">
          Manage studio instructors and profiles.
        </p>
      </div>
      ...
      <div className="mb-6">
        <div className="relative w-full">
          <span className="absolute left-[14px] top-1/2 -translate-y-1/2 text-[#8a8479] text-[14px] select-none">
            🔍
          </span>
          <input
            type="text"
            ...
            className="w-full py-[10px] pr-[14px] pl-[40px] rounded-[6px] border border-[#e5e2db] text-[13px] outline-none bg-white box-border focus:border-gray-400 transition-colors"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-[repeat(auto-fill,minmax(320px,1fr))] gap-6 mb-8">
        {filteredInstructors.map((inst) => (
          <div
            key={inst.id}
            className="bg-white rounded-lg border border-[#e5e2db] overflow-hidden flex flex-col"
          >
            ...
            <div className="p-5 flex-1 flex flex-col">
              <h2 className="text-[16px] font-bold mb-[2px] text-[#1a1a1a] font-serif leading-snug">
                {inst.name}
              </h2>
              <span className="text-[10px] font-bold text-[#a07153] tracking-[0.5px] uppercase mb-[10px] block">
                {inst.role}
              </span>
              <p className="text-[12px] text-[#736d65] leading-[1.4] mb-4 flex-1">
                {inst.bio}
              </p>
              ...
              <div className="flex flex-wrap gap-[6px] mb-4">
                {inst.tags.map((tag, idx) => (
                  <span
                    key={idx}
                    className="bg-[#f1efe9] text-[#55514a] text-[11px] px-2 py-[4px] rounded font-medium"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div>
                <button
                  ...
                  className="bg-[#c27d53] text-white border-none rounded px-[14px] py-[6px] text-[11px] font-semibold cursor-pointer hover:bg-[#b06c43] transition-colors"
                >
                  Remove
                </button>
              </div>
      ...
      <div className="bg-white rounded-lg border border-[#e5e2db] p-6 max-w-[480px]">
        <h2 className="text-[16px] font-bold mb-5 text-[#1a1a1a] font-serif">
          Add New Instructor
        </h2>
        ...
        <form onSubmit={handleAddInstructor}>
          <div className="grid grid-cols-2 gap-[12px] mb-4">
            <div>
              <label className="block text-[10px] font-bold text-[#8a8479] mb-[6px] tracking-[0.5px] uppercase">
                FULL NAME
              </label>
              <input
                type="text"
                ...
                className="w-full px-[12px] py-[9px] rounded border border-[#e5e2db] text-[12px] outline-none box-border focus:border-gray-400 transition-colors"
              />
            </div>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full px-[12px] py-[9px] rounded border border-[#e5e2db] text-[12px] outline-none box-border font-sans resize-y focus:border-gray-400 transition-colors"
            />
          </div>
          ...
          <div className="mb-5">
            ...
            <select
              ...
              className="w-full px-[12px] py-[9px] rounded border border-[#e5e2db] text-[12px] outline-none bg-white box-border focus:border-gray-400 transition-colors"
            >
          ...
          <button
            type="submit"
            className="bg-[#52614b] text-white border-none rounded px-[18px] py-[9px] text-[12px] font-semibold cursor-pointer hover:bg-[#43513c] transition-colors"
          >
            Add Instructor
          </button>
        </form>
...
// Generic Page Container for other simple views
export const PageContainer: React.FC<PageContainerProps> = ({
  title,
  subtitle,
}) => (
  <div className="max-w-[1150px] mx-auto">
    <h1 className="text-[28px] font-bold mb-2 text-[#1a1a1a] font-serif leading-tight">
      {title}
    </h1>
    <p className="text-[#8a8479] text-[13px] m-0">{subtitle}</p>
    <div className="mt-6 p-10 bg-white rounded-lg border border-[#e5e2db] text-[#686259]">
      {title} section view.
    </div>
  </div>
);
